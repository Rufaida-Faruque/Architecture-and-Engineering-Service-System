...
//   try {
//     setLoading(true);
//     // Send the clientId along with the sessionId
//     await axios.put(
...
//         data: { clientId } // Pass clientId to the backend
//       });
...
//       { winnerId, clientId } // Pass winnerId and clientId to the backend
//     );
...
// )}
// {session.winner && (
//   <p>Winner: {session.winner}</p> // Display the selected winner
// )}
