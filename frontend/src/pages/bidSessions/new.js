...
//       allowBidVisibility: form.allowVisibility,
//       clientId: userId,
//     };

//     try {
//       await axios.post("http://localhost:5000/api/bidSessions/create", payload);
...
//   // Ensure that only clients can access this page
//   if (!userId) return <h2>Loading...</h2>; // Wait for userId to be set
//   if (localStorage.getItem("role") !== "cl") return <h2>Unauthorized — Clients only</h2>;
...
//         value={form.allowVisibility}
//         onChange={handleInputChange}
//       >
//         <option value={true}>Visible to Service Providers</option>
//         <option value={false}>Hidden from Service Providers</option>
//       </select>
...
//     duration: "",       // Duration of the session in hours/minutes
//   });
